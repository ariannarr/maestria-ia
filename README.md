...
Este repositorio se crea para guardar los ejercicios, proyectos e información
relacionada con la Maestría en Inteligencia Artificial de la UADY.
...
- [Información del curso](Curso/informacion-del-curso.md) — contacto, sesiones y
  fechas de entrega.
- [Planeación didáctica](Curso/planeacion-didactica.md) — contenido temático,
  secuencia y evaluación.

## Tareas con `Entregable.md`
